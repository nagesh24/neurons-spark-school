...
export default function Students() {
  ...
  const empty = { full_name: "", admission_no: "", class_id: "none", roll_no: "", parent_name: "", parent_phone: "", email: "" };
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Roll</TableHead><TableHead>Parent</TableHead>{isAdmin && <TableHead className="w-12"></TableHead>}
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.length === 0 && (
                <TableRow><TableCell colSpan={6} className="text-center text-muted-foreground py-10">No students.</TableCell></TableRow>
              )}
              {filtered.map((s) => (
                <TableRow key={s.id}>
